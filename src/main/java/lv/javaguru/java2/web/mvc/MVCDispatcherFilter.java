...
//        controllerMapping.put("/main", getBean( MainMVCController.class));
//        controllerMapping.put("/trips", getBean( TripsMVCController.class));
//        controllerMapping.put("/addTrip", getBean( AddTripMVCController.class));
//        controllerMapping.put("/register", getBean( RegisterMVCController.class));
//
//    }
//
